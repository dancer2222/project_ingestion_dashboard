		...
		<div class="row">
			<div class="col-12 col-sm-12">
				...
				<div class="card">
					...
					<div class="card-body" v-if="abook">
						<div class="row">
							<div class="card_info_wrapper col-sm-12 col-lg-6">
								<h5 class="mb-4">
									<b>
										Show on prodution this audiobook -
										<a href="#" target="_blank">{{ abook.title }}</a>
									</b>
								</h5>

								<div class="card border-success" v-bind:class="[abook.status == 'active' ? 'border-success' : 'border-danger']">
									<div class="row" v-if="abook">
										<div class="image_wrapper">
											<span class="status" v-bind:class="[abook.status == 'active' ? 'badge-success' : 'badge-danger']">
												{{abook.status}}
											</span>
											<img
												v-if="abook.num_of_images > 0"
												v-bind:src="abook.img_url"
												alt="audiobook cover"
											/>
											<img v-else
										...
										<p class="card-title col-12" v-for="(value, title) in abook">
											...
											<b v-if="Array.isArray(value) && value.length > 0">
												...
												<span v-for="val in value">
													{{ val.name }} [{{ val.id }}]
													<span class="green">{{ val.status }}</span>
													<br />
												</span>
											</b>
										</p>
									...
									<div class="card-body p-b-0">
										<ul class="nav nav-tabs customtab2" role="tablist">
											...
											<li class="nav-item hidden">
												<a class="nav-link"
													data-toggle="tab"
													href="#audiobook_products"
													role="tab"
													aria-selected="false"
												>
													<span class="hidden-xs-down">Audiobook Products</span>
												</a>
											</li>
										</ul>
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="audiobook_products" role="tabpanel">

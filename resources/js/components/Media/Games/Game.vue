        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body" v-if="game">
						<div class="row">
							<div class="card_info_wrapper col-sm-12 col-lg-6">
								<h5 class="mb-4">
									<b>
										Show on prodution this game -
										<a href="#" target="_blank">{{ game.title }}</a>
									</b>
								</h5>

								<div class="card border-success" v-bind:class="[game.status == 'active' ? 'border-success' : 'border-danger']">
									<div class="row" v-if="game">
										<div class="image_wrapper">
											<span class="status" v-bind:class="[game.status == 'active' ? 'badge-success' : 'badge-danger']">
												{{game.status}}
											</span>
											<img
												v-if="game.num_of_images > 0"
										...
										<p class="card-title col-12" v-for="(value, title) in game">
											<b
												v-show="zeroShow"
												v-if="value == 0 && 
												value == '' &&
